...
<input type="email" class="form-control .form-control-lg" id="userlogin"aria-describedby="emailHelp" placeholder="User Login" disabled>
<input type="email" class="form-control .form-control-lg" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your email" name="email"> <small id="emailHelp" class="form-text text-muted"></small>
    ...
    <label for="exampleInputPassword1"></label>
          <input type="password" class="form-control" id="exampleInputPassword1" name="pwd" placeholder="Password" name="password">
</div>
        
                   </div>
                   <a href="resetpass.php"> <h6>Forgot Password?</h6></a>
