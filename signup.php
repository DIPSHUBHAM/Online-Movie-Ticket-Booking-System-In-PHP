...
<input type="text" class="form-control .form-control-lg" id="userlogin"aria-describedby="emailHelp" placeholder="Signup" disabled>
<input type="text" class="form-control .form-control-lg" id="userlogin"aria-describedby="emailHelp" placeholder="Your First Name" name="name">
